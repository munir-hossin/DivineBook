        ...
        <>
            <div className="flex px-4 h-20 items-center border-b">
                ...
                <div className="flex ml-auto">
                    ...
                    <div className="ml-4 border border-red-400 hover:bg-red-400 hover:bg-opacity-25 rounded dark:border-green-400 dark:hover:bg-green-400 dark:hover:bg-opacity-25 p-3 cursor-pointer">
                        {/* <IoIosSunny className="text-red-400 dark:text-green-400 mx-auto text-base" /> */}
                        {/* 
                        <IoIosSunny
                        onClick={themeHandler}
                        className={`text-xl text-red-400 dark:text-green-400 cursor-pointer ${theme === 'text-red-400' && 'text-green-400'}`} 
                        /> */}
                                                            ...
                                                            {cartItems.map((item) => (
                                                                <tr key={item.id} className="border-t border-gray-600">
                                                                    <td className="flex items-center py-4">
                                                                        <img src={getImage(`../assets/book_images/${item.image}`)} alt={item.name} className="h-14 mr-2" />
                                                                        <div>
            ...
            <div>
                ...
                <div className="h-screen flex">
                    ...
                    <aside className="w-1/6 p-4 hidden lg:block">
                        {/* Search Bar */}
                        <div className="cursor-pointer border overflow-hidden  border-gray-300 hover:border-red-300 dark:border-green-400 rounded-md flex dark:bg-gray-900 p-2 items-center mb-6 mt-4">
                            <i className="cursor-pointer fa-solid fa-magnifying-glass text-gray-500"></i>
                            <input onClick={() => setIsSearchModalOpen(true)} onChange={handleSearchChange} className="border-none dark:bg-gray-900 w-full lg:w-52 outline-none ml-2" type="text" placeholder="Quick search..." />
                        </div>
                    ...
                    {isLeftModalOpen && (
                        ...
                        >
                            <div className="w-3/4 sm:w-1/2 md:w-1/3 bg-white dark:bg-gray-900 p-4 h-full">
                                {/* Close Button */}
                                <button className="text-2xl mb-4" onClick={toggleLeftModal}>
                                    ✕ {/* Replace with a different icon if preferred */}
                                </button>

                                {/* Modal Content (same as the sidebar) */}
                                <div className="cursor-pointer border border-gray-300 hover:border-red-300 dark:border-green-400 rounded-md flex dark:bg-gray-900 p-2 items-center mb-6 mt-4">
                                    <i className="cursor-pointer fa-solid fa-magnifying-glass text-gray-500"></i>
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        className="cursor-pointer mb-4 flex items-center py-2 px-4 border-l-2 rounded border-transparent hover:text-red-400 hover:border-gray-300 dark:hover:bg-green-400"
                                    >
                                        <FaFire className="mr-3" />
                                        <span>Trending</span>
                                    </div>
                    ...
                    <main className="flex-1 px-2 pt-8 pb-5 overflow-y-auto border relative">
                        ...
                        <button className="block lg:hidden text-2xl absolute top-1 left-1" onClick={toggleLeftModal}>
                            ☰ {/* Replace with your icon if needed */}
                        </button>

                        {/* Right side bar icon 3 dod */}
                        <div className="lg:hidden p-4 ">
                            <CiMenuKebab className="text-2xl cursor-pointer absolute top-3 right-1" onClick={toggleModal} />
                        </div>
                                    ...
                                    <dialog onClick={(e) => e.stopPropagation()} id="my_modal_4" className="modal" open>
                                        <div className="w-8/12 max-w-5xl">
                                            ...
                                            <div className="flex text-gray-300 bg-[#1e293b] rounded-2xl items-center">
                                                ...
                                                {/* Book Image */}
                                                <div>
                                                    <img className="rounded-r-xl" src={getImage(`../assets/book_images/${selectedBook.image}`)} alt="Book Image" />
                                                </div>
                                            </div>
                                        </div>
                                    </dialog>
