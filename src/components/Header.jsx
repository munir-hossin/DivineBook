        ...
        <>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-gray-700 bg-opacity-25 flex items-center justify-center z-50">
                    <dialog
                        ref={modalRef}
                        className="modal w-full max-w-3xl mx-4 sm:mx-8 md:mx-auto"
                        open
                    >
                            ...
                            <div className="bg-gray-900 text-white w-[92%] rounded-[10px] pb-3 pt-1 px-4  lg:h-[440px] md:h-auto">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mr-7">
                                    ...
                                    <div>
                                        ...
                                        <button className="w-full md:w-[200px] py-2 px-6 md:px-[70px] bg-[#009A67] text-white rounded-sm md:mt-2 md:mx-7">
                                            Checkout
                                        </button>
                                    </div>
                                </div>
...
// function Header({openModal, isModalOpen, closeModal, totalItems, cartItems, handleDecrement, handleIncrement, handleDelete, totalPrice}) {
