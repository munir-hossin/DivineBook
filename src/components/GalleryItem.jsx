    ...
    return (
        <div className="w-[300px] cursor-pointer mx-auto sm:w-full hover:shadow hover:border-gray-200 border border-white dark:border-gray-600  p-3 rounded flex flex-col justify-between">
            ...
            <div className="flex mt-2">
                {/* Add to Cart button */}
                <div className="w-full text-center mr-2 py-2 dark:border-none dark:text-black dark:bg-green-400  hover:shadow hover:-translate-y-[1px] border  rounded text-red-400 font-medium">
                ...
                <div
                    className={` dark:hover:bg-green-400 dark:hover:bg-opacity-25 ml-auto dark:text-green-500 hover:shadow hover:-translate-y-[1px] border dark:border-green-400 text-red-400 font-medium px-3 flex items-center justify-center rounded-md cursor-pointer ${
