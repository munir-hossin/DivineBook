...
function LeftSideModal({setIsSearchModalOpen, handleSearchChange, sortByTrending, toggleLeftModal, filterByStatus, selectItems, setSortedBooks, initialBookData, isLeftModalOpen}) {
    return (
        <>
         {isLeftModalOpen && (
                 <div
